...
- **2 teams (🔴 RED)** need immediate mandatory intervention (Kinnect, TerraTruth)
- **2 teams (🟡 YELLOW)** need strong pivot recommendation (PitchPeer, SoundScape)
- **3 teams (🟠 ORANGE)** need close monitoring (TripTuner, AgriAid, Urban Explorer)
- **2 teams (✅ GREEN)** are on reasonable paths with managed risks (StreetEats, MoodMap)
...
✅ All 9 teams received feedback
✅ Kinnect & TerraTruth attended mandatory meetings
✅ At least 1 of those 2 committed to pivot in writing
✅ All teams submitted revised scopes (≤6 features)
✅ Tracking sheet populated with green/yellow/red flags
...
✅ Send `02-team-summary-report.md` to students
✅ Send excerpts from `05-alternate-ideas.md` to specific teams
✅ Use all talking points verbatim
✅ Share with TAs or co-instructors
✅ Adapt for future semesters
✅ Use for research (with student consent)

### Please Consider

💡 Customize email templates with your actual office hours/dates
💡 Print `INSTRUCTOR-CHEAT-SHEET.md` before meetings (it helps!)
💡 Track actual vs. predicted outcomes to validate analysis
💡 Update course materials based on `03-common-lessons.md`
...
✅ Actionable guidance (every criticism has a solution)
✅ Realistic predictions (based on past projects and timeline math)
✅ Complete alternatives (not just "pivot," but "here's exactly how")
✅ Intervention playbook (what to do, when, with whom)
✅ Reusable framework (V2 prompt works for future cohorts)

**Every team can succeed if they act this week.**

Your job: Make them listen.

**The 96-hour window starts Monday morning.** 🚀
...
**Good luck saving these projects!** 💪
